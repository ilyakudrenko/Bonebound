...
func spawn_shatter_pieces() -> void:
	spawn_shatter_piece(Vector2(-28, -94), Vector2(28, 10), Color(0.78, 0.2, 0.08, 1), Vector2(-180, -170))
	spawn_shatter_piece(Vector2(0, -80), Vector2(24, 10), Color(0.15, 0.09, 0.06, 1), Vector2(120, -150))
	spawn_shatter_piece(Vector2(26, -56), Vector2(36, 8), Color(0.18, 0.1, 0.06, 1), Vector2(220, -110))
	spawn_shatter_piece(Vector2(-18, -42), Vector2(18, 42), Color(0.42, 0.29, 0.19, 1), Vector2(-120, -80))
	spawn_shatter_piece(Vector2(10, -38), Vector2(16, 52), Color(0.29, 0.19, 0.13, 1), Vector2(80, -70))
	spawn_shatter_piece(Vector2(26, -18), Vector2(28, 8), Color(0.15, 0.09, 0.06, 1), Vector2(190, -60))
	spawn_shatter_piece(Vector2(-18, -6), Vector2(30, 10), Color(0.65, 0.18, 0.08, 1), Vector2(-90, -40))
