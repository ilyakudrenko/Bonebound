...
const SWORD_PICKUP_SCENE_PATH := "res://scenes/scaled_objects/SwordPickup_16px.tscn"
...
func _on_body_entered(body: Node) -> void:
	...
	var old_weapon_type: String = body.call("exchange_main_weapon", "axe")
...
func swap_weapon_with_player() -> void:
	...
	var old_weapon_type: String = nearby_player.call("exchange_main_weapon", "axe")
	if old_weapon_type == "blocked":
		return
	...
	if old_weapon_type == "sword":
		spawn_old_weapon(SWORD_PICKUP_SCENE_PATH)
